...
public class EhCache<K, V> implements Cache<K, V> {
	...
	/**
	 * Returns the size (in bytes) that this EhCache is using in memory (RAM), or <code>-1</code> if that number is unknown or cannot be calculated.
	 *
	 * @return the size (in bytes) that this EhCache is using in memory (RAM), or <code>-1</code> if that number is unknown or cannot be calculated.
	 */
	...
	/**
	 * Returns the size (in bytes) that this EhCache's memory store is using (RAM), or <code>-1</code> if that number is unknown or cannot be
	 * calculated.
	 *
	 * @return the size (in bytes) that this EhCache's memory store is using (RAM), or <code>-1</code> if that number is unknown or cannot be
	 *         calculated.
	 */
