...
public class BankCardUtils {
	 ...
	 * 发卡行机构代码
	 */
	public static Map<String, String> bankCardCodes = new HashMap<String, String>();

	/**
	 * 银行卡类型
	 */
	public static Map<String, String> bankCardTypes = new HashMap<String, String>();

	static {

		bankCardCodes.put("01000000", "邮储银行");
		bankCardCodes.put("01020000", "工商银行");
		bankCardCodes.put("01030000", "农业银行");
		bankCardCodes.put("01040000", "中国银行");
		bankCardCodes.put("01050000", "建设银行");
		bankCardCodes.put("01059999", "中国建设银行");
		bankCardCodes.put("03010000", "交通银行");
		bankCardCodes.put("03020000", "中信银行");
		bankCardCodes.put("03030000", "光大银行");
		bankCardCodes.put("03040000", "华夏银行");
		bankCardCodes.put("03050000", "民生银行");
		bankCardCodes.put("03060000", "广发银行");
		bankCardCodes.put("03080000", "招商银行");
		bankCardCodes.put("03090000", "兴业银行");
		bankCardCodes.put("03100000", "上海浦东发展银行");
		bankCardCodes.put("04012900", "上海银行");
		bankCardCodes.put("04105840", "平安银行");

		// 00：未知 01：借记账户 02：贷记账户 03：准贷记账户 04：借贷合一账户 05：预付费账户 06：半开放预付费账户
		bankCardTypes.put("00", "未知");
		bankCardTypes.put("01", "借记账户");
		bankCardTypes.put("02", "贷记账户");
		bankCardTypes.put("03", "准贷记账户");
		bankCardTypes.put("04", "借贷合一账户");
		bankCardTypes.put("05", "预付费账户");
		bankCardTypes.put("06", "半开放预付费账户");
	...
	public static void main(String[] args) {
		String cardNumber = "6212263602032472060";// 卡号
		String name = getNameOfBank(cardNumber);
		if (!StringUtils.isEmpty(name)) {
			String[] banks = name.split("·");
			String bankCardName = banks[0];
			String bankCardType = banks[1];
			System.out.println(bankCardName + "------" + bankCardType);
		}
	}
