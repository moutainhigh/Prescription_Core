...
public class ShardedRedisServiceImpl implements RedisService {
	...
	public List<String> mget(String... keys) {
		...
		try {
			ShardedJedisPipeline pipeline = jedis.pipelined();
			List<Response<String>> responseList = new ArrayList<>(keys.length);
			for (String key : keys) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sunshine.framework.cache.redis.RedisService#pipelineGetHDatas(java.util .List, java.lang.String)
	 */
	@Override
	...
	@Override
	public <T> Boolean pipelinedHash(String cacheKey, Map<String, List<T>> dataMap) {
		// TODO Auto-generated method stub
		ShardedJedis jedis = getRedisClient();
		Boolean result = true;
		if (jedis == null) {
	...
	public List<Object> pipelined(Map<String, String> setDataMap, List<String> getDataKeys) {
		...
		try {
			...
			List<Response<String>> reses = new ArrayList<>();
