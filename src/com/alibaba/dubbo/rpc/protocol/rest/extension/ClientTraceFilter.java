...
public class ClientTraceFilter implements ClientRequestFilter, ClientResponseFilter {
	...
	public void filter(ClientRequestContext requestContext) throws IOException {
		logger.info("ClientIp:" + RpcContext.getContext().getRemoteAddressString() + ",event:Client request filter invoked");
	}

	@Override
	public void filter(ClientRequestContext clientRequestContext, ClientResponseContext clientResponseContext) throws IOException {
		logger.info("ClientIp:" + RpcContext.getContext().getRemoteAddressString() + ",event:Client response filter invoked");
	}
}
